    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
        {jurisdictions.map((jurisdiction) => (
          <label className={`rounded-lg p-4 cursor-pointer border-2 transition-all duration-300
          ...
          >
            <div className="flex justify-between items-center ">
              <h3 className="font-semibold text-gray-700">{jurisdiction.title}</h3>
              <input
                type="radio"
                name="jurisdiction"
            ...
            <ul className="mt-2 space-y-1">
              {[...Array(3)].map((_, i) => (
                <li key={i} className="flex items-center text-gray-600">
                  <span className="mr-2 text-blue-500"><img src={checkIcon} alt="Checked" className="w-6 h-6 mx-auto" /> </span>
...
>
  ...
  Compare Options
      ...
      {/* Custom Jurisdiction */}
      <h3 className="mt-6 text-lg font-semibold">Prefer a Different Jurisdiction?</h3>
      ...
      {/* Dropdowns - Only visible when showDropdowns is true */}
      {showDropdowns && (
      ...
      <div className="relative bg-gradient-to-r from-blue-100 to-blue-50 p-4 rounded-lg shadow-sm flex items-center justify-between w-full mt-6">
        <p className="text-sm">
          Do you want to optimize your <span className="text-blue-600 font-semibold">Corporate Tax?</span>
        </p>
